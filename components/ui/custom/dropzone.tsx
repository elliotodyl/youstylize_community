...
export const DropzoneContent = ({ children }: DropzoneContentProps) => {
	...
	return (
		<>
			...
			<p className="w-full text-xs font-normal text-muted-foreground">Drag and drop or click to replace</p>
		</>
	);
};
...
export const DropzoneEmptyState = ({ children }: DropzoneEmptyStateProps) => {
	...
	return (
		<>
			...
			<p className="my-2 w-full truncate text-sm font-normal">Upload {maxFiles === 1 ? "a file" : "files"}</p>
			<p className="w-full truncate text-xs text-muted-foreground">Drag and drop or click to upload</p>
